...
<body>
	...
	<ul id="navbar">
		<c:if test="${not empty requestScope.Messege}">
			...
			<li><a>title:<c:out value="${requestScope.book.name}" /></a></li><br /> 
			<li><a>author:<c:out value="${requestScope.book.author}" /></a></li><br /> 
			<li><a>published in:<c:out value="${requestScope.book.age}" /></a></li><br /> 
